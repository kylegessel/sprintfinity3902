...
namespace Sprintfinity3902
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            CollisionDetector.Instance.CheckCollision(currentRoom.enemies, currentRoom.blocks, currentRoom.items, linkProj,currentRoom.enemyProj,currentRoom.doors, currentRoom.garbage, (IProjectile)bombExplosion);
