...
{
    public class RopeSnakeMovingDownFacingRightState : IEnemyState
    {
        ...
        public RopeSnakeMovingDownFacingRightState(RopeSnakeEnemy ropesnake) /*This should be Interface*/
        {
            RopeSnake = ropesnake;
