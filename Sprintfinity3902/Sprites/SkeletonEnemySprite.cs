...
namespace Sprintfinity3902.Sprites
{
    public class SkeletonEnemySprite : AbstractSprite
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, Vector2 position, Color color) {
            spriteBatch.Draw(Texture, position, Animation.CurrentFrame.Sprite.SourceRectangle, Color.White, 0f, new Vector2(0, 0), 4.0f, Animation.CurrentFrame == Animation.GetFrame(1) ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0);
        }
