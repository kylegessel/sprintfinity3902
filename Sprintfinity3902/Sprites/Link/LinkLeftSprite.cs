...
namespace Sprintfinity3902.Sprites
{
    public class LinkLeftSprite : AbstractSprite
    {
        ...
        {
            spriteBatch.Draw(Texture, position, Animation.CurrentFrame.Sprite.SourceRectangle, color, 0f, new Vector2(0, 0), Globals.GlobalVariables.SCALE, SpriteEffects.FlipHorizontally, 0);
        }
    }
}
