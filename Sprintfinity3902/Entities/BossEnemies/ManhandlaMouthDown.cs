...
{
    public class ManhandlaMouthDown : AbstractEntity, IEnemy
    {
        ...
        public ManhandlaMouthDown(Vector2 pos, IAttack fire)
        {
            Sprite = EnemySpriteFactory.Instance.CreateManhandlaDownMouth();
            Position = pos;
            fireAttack = fire;
